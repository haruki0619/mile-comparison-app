...
export interface PointTransferOption {
  creditCardPoints: CreditCardTransfer[];
  bankPoints: BankPointTransfer[];
  hotelPoints: HotelPointTransfer[];
...
export interface RealTimeMonitoring {
  ...
  transferPromotionAlerts: TransferPromotionAlert[];
}
